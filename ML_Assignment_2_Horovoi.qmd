...
fit_list <- readRDS(url("https://github.com/Horovoi/ML-KSE-HW2/blob/main/data/fit.Rds?raw=true","rb"))
...
# Load pre-estimated models' parameters from the GitHub repo
fit_better_list <- readRDS(url("https://github.com/Horovoi/ML-KSE-HW2/blob/main/data/fit_Dnipro.Rds?raw=true", "rb"))
